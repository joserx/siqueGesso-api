...
export class RhEntity {
  ...
  @OneToMany(() => FaltaEntity, (falta) => falta.rh, {
    nullable: true,
    onDelete: 'CASCADE',
  ...
  @OneToMany(() => AusenciaEntity, (ausencia) => ausencia.rh, {
    nullable: true,
    onDelete: 'CASCADE',
    cascade: ['insert', 'update'],
  })
  ...
  @OneToMany(() => ExameEntity, (exame) => exame.rh, {
    nullable: true,
    onDelete: 'CASCADE',
    cascade: ['insert', 'update'],
  })
  ...
  @OneToMany(() => EmbarqueEntity, (embarque) => embarque.rh, {
    nullable: true,
    onDelete: 'CASCADE',
    cascade: ['insert', 'update'],
  })
